def parse_sentence(user_input):                             
    ...
    path = 'C:\\Users\\Triton\\Downloads\\stanford-corenlp-full-2018-10-05\\stanford-corenlp-full-2018-10-05\\'
    path_to_jar = path + 'stanford-corenlp-3.9.2.jar'
...
def classify_model():
    ...
    FNAME = 'C:/Users/Triton/Desktop/featuresDump.csv'
...
def classify_sentence(clf,user_input):
    ...
    "sTripleScore",
    "class"]
    myFeatures = featuress.features_dict('1',user_input, 'X')
    values=[]
    for key in keys:
...
def setup_database():
    ...
    db = mysql.connector.connect(user='root',password='root',host='Localhost',database='mapbot')
    cur = db.cursor()
